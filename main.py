...
PLAYER_SHOOT_WIDTH = 62 # SAME HEIGHT
PLAYER_JUMP_SHOOT_WIDTH = 58 # SAME JUMP HEIGHT
PLAYER_DISTANCE = 5
...
player_image_jump_shoot_right = load_image("megaman-right-jump-shoot.png", (PLAYER_JUMP_SHOOT_WIDTH, PLAYER_JUMP_HEIGHT))
    ...
    class Bullet(pygame.Rect):
        def __init__(self):
            ...
            if player.direction == "left":
                ...
                self.velocity_x = -PLAYER_BULLET_VELOCTIY_X
